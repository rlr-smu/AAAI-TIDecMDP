...
class Config:
    def __init__(self, experiment, args=None):
        ...
        self.offset = 500
        self.timeout = 200
        self.workDir = "/home/tarun/Successor-Representation/"
        self.theta = 0.1
        self.gamma = 0.9999
        ...
        self.lastKIter = -100
        self.loggingThreshold = -1*(self.lastKIter)
        self.savingEveryXIter = 1000
        self.runWithSavedModel = False
        self.EDlearningRate = 0.001
        self.MlearningRate = (self.EDlearningRate)/2.0
        self.PolMDPlearningRate = (self.EDlearningRate)/10.0
        self.PolEVlearningRate = (self.EDlearningRate)/10.0
        self.batch = 30
        self.numUnitsPerLayer = 32
        self.saveMValuesDir = self.workDir+"MValues/"
        self.saveModelsDir = self.workDir+"models/"
        self.loadPolicyFile = ""
        self.loadPolicyFileFull = self.saveModelsDir + self.loadPolicyFile + ".ckpt"
        self.annealRandomActProb = False
        self.randomActionProb = 0.0
        self.MValuesPeriodicUpdateEveryXIter = 30
        self.featsS = 75
        self.featsSAS = 75
        self.normalizeMSAW = False
        self.normalizeCK = False
        self.NNlayerNorm = False
        self.PollayerNorm = False
        self.ReplayerNorm = False
    ...
    def generateDomain(self):
        ...
        print "[ED] Learning Rate: ", self.EDlearningRate
        print "[M] Learning Rate: ", self.MlearningRate
        print "[MDP-Pol] Learning Rate: ", self.PolMDPlearningRate
        print "[EV-Pol] Learning Rate: ", self.PolEVlearningRate
