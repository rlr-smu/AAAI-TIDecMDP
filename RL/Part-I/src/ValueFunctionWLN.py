...
#         self.updates = None
    ...
    def initNNVF(self, drate):
        ...
        norm1 = tf.contrib.layers.layer_norm(inputs=self.input_var, trainable=True, scope="NormLayer_1_Baseline_Agent_"+str(self.agent))
        l_in = tf.layers.dense(inputs=norm1, units=self.config.numUnitsPerLayer, activation=tf.nn.relu, trainable=True, name="DenseReLu_1_Baseline_Agent_"+str(self.agent))
        dropout1 = tf.layers.dropout(inputs=l_in, rate=drate, training=self.train_mode, name="Dropout_1_Baseline_Agent_"+str(self.agent))

        norm2 = tf.contrib.layers.layer_norm(inputs=dropout1, trainable=True, scope="NormLayer_2_Baseline_Agent_"+str(self.agent))
        l_hid2 = tf.layers.dense(inputs=norm2, units=self.config.numUnitsPerLayer, activation=tf.nn.relu, trainable=True, name="DenseReLu_2_Baseline_Agent_"+str(self.agent))
        ...
        norm3 = tf.contrib.layers.layer_norm(inputs=dropout2, trainable=True, scope="NormLayer_3_Baseline_Agent_"+str(self.agent))
        l_hid3 = tf.layers.dense(inputs=norm3, units=self.config.numUnitsPerLayer, activation=tf.nn.relu, trainable=True, name="DenseReLu_3_Baseline_Agent_"+str(self.agent))
        ...
        norm4 = tf.contrib.layers.layer_norm(inputs=dropout3, trainable=True, scope="NormLayer_4_Baseline_Agent_"+str(self.agent))
        l_hid4 = tf.layers.dense(inputs=norm4, units=self.config.numUnitsPerLayer, activation=tf.nn.relu, trainable=True, name="DenseReLu_4_Baseline_Agent_"+str(self.agent))
        ...
        norm5 = tf.contrib.layers.layer_norm(inputs=dropout4, trainable=True, scope="NormLayer_5_Baseline_Agent_"+str(self.agent))
        l_out = tf.layers.dense(inputs=norm5, units=1, activation=None, name="Dense_5_Baseline_Agent_"+str(self.agent))
